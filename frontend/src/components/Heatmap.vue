<template>
    <div ref="mapChart" class="mapItem"></div>

    <el-select filterable class="filterItem" v-model="selectedProvinces" multiple collapse-tags collapse-tags-tooltip
        :max-collapse-tags="4" placeholder="选择省份">
        <template #header>
